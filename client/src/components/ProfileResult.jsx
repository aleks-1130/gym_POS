...
export default function ProfileResult({ logId: propLogId, ...props }) {
    ...
    if (!log && !error && !loading) {
        return (
            <div className="bg-surface rounded-3xl border border-white/5 p-12 text-center h-full flex flex-col items-center justify-center min-h-[400px]">
