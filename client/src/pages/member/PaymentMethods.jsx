    ...
    return (
        <div className="space-y-6 pb-24 max-w-2xl mx-auto">
            ...
            <section className="bg-surface rounded-2xl p-5 border border-white/5">
                ...
                <form className="grid grid-cols-1 sm:grid-cols-2 gap-3" onSubmit={handleAddGcash}>
                    <input
                        className="bg-surfaceHighlight border border-white/10 rounded-xl px-3 py-2 text-sm text-white placeholder:text-text-muted"
                    ...
                    />
                    <input
                        className="bg-surfaceHighlight border border-white/10 rounded-xl px-3 py-2 text-sm text-white placeholder:text-text-muted sm:col-span-2"
