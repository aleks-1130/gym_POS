    ...
    <div className="pb-24 px-4 sm:px-6 max-w-6xl mx-auto space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-wrap gap-2">
        {[
          ...
          <button
            key={tab.id}
            className={`px-3 py-1.5 rounded-full text-xs font-semibold border ${filterView === tab.id
      ...
      {showBookingModal && selectedTrainer && (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
          ...
          <div className="relative bg-surface rounded-2xl border border-white/10 w-full max-w-lg p-6 max-h-[90vh] overflow-y-auto">
                    ...
                    {paymentMethods
                      ...
                      .map((method) => (
                        <button
                          ...
                          className={`text-left w-full rounded-xl border px-3 py-2 transition-all ${selectedMethodId === method.id
                        ...
                        >
                          <div className="flex items-center justify-between gap-2">
                            ...
                            <span className={`w-3 h-3 rounded-full border ${selectedMethodId === method.id
