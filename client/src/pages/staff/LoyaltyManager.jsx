        ...
        <div className="space-y-8">
            <header className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-text-muted mt-1">Manage points program</p>
                </div>
                <div className="bg-surface px-6 py-3 rounded-2xl border border-white/5 shadow-sm">
                    <span className="block text-xs text-text-muted uppercase tracking-widest font-bold">Total Points Issued</span>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
                {/* Rewards List */}
                <div className="bg-surface rounded-3xl border border-white/5 p-8 shadow-sm">
